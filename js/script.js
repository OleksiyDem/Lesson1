...
//  Math.floor(num) - повертає найбільше ціле число, яке меньше,
//або  таке, що дорівнює вказаному
// console.log(Math.floor(1.7)); // 1

// // Math.ceil(num) - повертає наименьше ціле число, яке більше,
// //або  таке, що дорівнює вказаному
...
// console.log(Math.random() * (max - min) + min); //випадкове число від (min) до (max)
//------------------------------------------------//
